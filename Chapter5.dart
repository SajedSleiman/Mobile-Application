...
class Chapter5 extends StatefulWidget {
  final String userId;  // Keep userId as String
...
class _Chapter5State extends State<Chapter5> {
  ...
  final int _correctAnswer1 = 1;
  final int _correctAnswer2 = 0;
  ...
  Widget build(BuildContext context) {
    bool bothAnswersCorrect = _feedback1.startsWith('✅') && _feedback2.startsWith('✅');
